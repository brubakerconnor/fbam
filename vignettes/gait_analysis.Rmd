...
vignette: >
  %\VignetteIndexEntry{gait_analysis}
...
```{r run_fbam, echo=FALSE, cache=TRUE}
...
descriptors included in the data. Below are the summary statistics for
the covariates among each of the subpopulations.
